...
import { Laptop, ShieldAlert, Settings2, Sparkles } from "lucide-react";
...
const skills = [
  ...
  },
  {
    ...
    items: [
      { name: "ChatGPT & Gemini", level: 92 },
      { name: "NotebookLLM", level: 85 },
      ...
      <div className="container px-6 mx-auto">
        <div className="text-center mb-20">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            A comprehensive matrix of my expertise across device management, enterprise security, and modern AI productivity tools.
          </p>
        </div>
